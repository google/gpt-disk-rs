...
#[doc = "Globally-unique identifier (8-byte aligned).
...
impl Default for AlignedGuid {
    fn default() -> Self {
        Self::ZERO
    }
}

impl Display for AlignedGuid {
...
impl From<crate::Guid> for AlignedGuid {
    fn from(g: crate::Guid) -> Self {
        Self {
            time_low: g.time_low,
            time_mid: g.time_mid,
...
#[cfg(feature = "serde")]
impl Serialize for AlignedGuid {
...
impl<'de> Visitor<'de> for DeserializerVisitor {
    ...
    where
        E: de::Error,
    {
        AlignedGuid::try_parse(value).map_err(E::custom)
    }
}

#[cfg(feature = "serde")]
impl<'de> Deserialize<'de> for AlignedGuid {
