...
impl Default for VAR_STRUCT_NAME {
    fn default() -> Self {
        Self::ZERO
    }
}

impl Display for VAR_STRUCT_NAME {
...
impl From<crate::VAR_OTHER_STRUCT_NAME> for VAR_STRUCT_NAME {
    fn from(g: crate::VAR_OTHER_STRUCT_NAME) -> Self {
        Self {
            time_low: g.time_low,
            time_mid: g.time_mid,
...
#[cfg(feature = "serde")]
impl Serialize for VAR_STRUCT_NAME {
...
impl<'de> Visitor<'de> for DeserializerVisitor {
    ...
    where
        E: de::Error,
    {
        VAR_STRUCT_NAME::try_parse(value).map_err(E::custom)
    }
}

#[cfg(feature = "serde")]
impl<'de> Deserialize<'de> for VAR_STRUCT_NAME {
